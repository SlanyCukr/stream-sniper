...
import type { TrackedStreamer, TwitchProbeResult } from '@/hooks/admin/tracking/useTrackingQueries'

interface TwitchProbeCellProps {
    streamer: TrackedStreamer
    result: TwitchProbeResult | undefined
    probing: boolean
    onProbe: (streamerId: number) => void
}
...
interface TrackedStreamerTableProps {
    ...
    onToggleActive: (streamerId: number, currentStatus: boolean) => void
    onToggleProcessing: (streamerId: number, currentStatus: boolean) => void
    onRemove: (streamer: TrackedStreamer) => void
    onProbe: (streamerId: number) => void
    probeResults?: Record<number, TwitchProbeResult>
