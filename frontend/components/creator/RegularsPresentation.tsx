...
import type { CreatorRegular } from '@/hooks/creator/useCreatorRegularsQuery'
...
interface RegularsControlsProps {
    minStreams: number
    onMinStreamsChange: (event: ChangeEvent<HTMLInputElement>) => void
    regularCount: number
    totalStreams: number
    showReadout: boolean
}
