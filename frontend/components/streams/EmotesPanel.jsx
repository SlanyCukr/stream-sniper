...
import { useStreamEmotes } from '@/hooks/useApiQuery'
...
const EmotesPanel = ({ streamId }) => {
    ...
    return (
        <Card className="insight-panel">
            <Card.Body>
                <h3 className="section-label mb-3">Top emotes</h3>
                ...
                {!isLoading && !error && emotes.length === 0 && (
                    <div className="empty-state">
                        <div
                            className="empty-scope"
                            aria-hidden="true" />
                        <p className="empty-title">No emotes</p>
                        <p className="empty-hint">
                            Emote rollups are still pending for this stream.
                        </p>
                    </div>
                )}
