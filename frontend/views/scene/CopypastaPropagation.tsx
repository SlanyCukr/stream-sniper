...
const stamp = (value: string | null) => (value ? value.replace('T', ' ').slice(0, 16) : '--')

interface CopypastaPropagationProps {
    messageTextId: number
}

const CopypastaPropagation = ({ messageTextId }: CopypastaPropagationProps) => {
