...
class PerformanceTimer:
    ...
    def __init__(self, logger: logging.Logger, operation: str, 
                 level: int = logging.INFO, slow_threshold: float = 1.0):
        self.logger = logger
...
class LoggingConfig:
    ...
    def __init__(self, 
        ...
        self.enable_json_logging = enable_json_logging if enable_json_logging is not None else (self.environment == 'production')
    ...
    def configure_logging(self, 
                         ...
                         disable_existing_loggers: bool = False) -> logging.Logger:
