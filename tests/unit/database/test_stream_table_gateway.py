...
class TestStreamTableGateway:
    ...
    def test_select_all_streams_db_all_creators(self, db_cursor):
        ...
        creator1_id = create_test_creator(db_cursor, {'nick': 'creator1', 'display_name': 'Creator 1', 'profile_image_url': 'url1', 'twitch_id': '111'})
        creator2_id = create_test_creator(db_cursor, {'nick': 'creator2', 'display_name': 'Creator 2', 'profile_image_url': 'url2', 'twitch_id': '222'})
    ...
    def test_select_creators_that_wrote_in_stream_db(self, db_cursor):
        ...
        # Create test data
        main_creator_id = create_test_creator(db_cursor, {'nick': 'main_creator', 'display_name': 'Main Creator', 'profile_image_url': 'url1', 'twitch_id': '111'})
        other_creator_id = create_test_creator(db_cursor, {'nick': 'other_creator', 'display_name': 'Other Creator', 'profile_image_url': 'url2', 'twitch_id': '222'})
...
class TestStreamTableGatewayWithMocks:
    ...
    def test_select_stream_comprehensive_db_with_mock(self, mock_connection_pool):
        ...
        mock_cursor.fetchone.return_value = (
            'Test Stream', '2024-01-15 20:00:00', '2024-01-15 23:00:00',
            'thumb.jpg', 150, 'creator_nick', 'Creator Name', 'profile.jpg', 1
        )
