...
class TestChatProcessor:
    ...
    def sample_chat(self):
        ...
        return [
            ...
            },
            {
                ...
                'message': 'Great stream! @streamer',
                'timestamp': 1642287045000000
            },
            {
                'author': {'name': 'stream_regular'},
                'message': 'PogChamp',
                'timestamp': 1642287075000000
            },
            {
    ...
    def test_chat_processor_with_malformed_messages(self, chat_processor, mock_handler):
        ...
        malformed_chat = [
            ...
            # Missing message
            {
                'author': {'name': 'user_without_message'},
                'time_in_seconds': 2.0
            },
            # Valid message
            {
                'author': {'name': 'valid_user'},
    ...
    def test_chat_processor_unicode_handling(self, chat_processor):
        ...
        unicode_chat = [
            {
                'author': {'name': 'user_emoji'},
                'message': 'Hello! 😀🎮💜',
                'time_in_seconds': 1.0
            },
            {
                'author': {'name': 'user_chinese'},
                'message': '你好世界',
                'time_in_seconds': 2.0
            },
            {
                'author': {'name': 'user_symbols'},
                'message': '★☆♦♣♠♥',
                'time_in_seconds': 3.0
            }
        ]
