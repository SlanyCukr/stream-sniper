...
def get_sample_chat_messages() -> List[Dict[str, Any]]:
    ...
    for author_name, message_text, time_offset in message_data:
        messages.append({
            ...
            'time_in_seconds': base_time + time_offset
        })
...
SAMPLE_API_RESPONSES = {
    ...
    'streams': [
        [1, 'Epic Gaming Session - Day 1', '2024-01-15 20:00:00', '2024-01-15 23:30:00', 'https://example.com/thumbnail1.jpg', 1250],
        [2, 'Chill Coding Stream', '2024-01-16 20:00:00', '2024-01-17 00:00:00', 'https://example.com/thumbnail2.jpg', 856],
        [3, 'Community Game Night', '2024-01-17 20:00:00', '2024-01-17 22:45:00', 'https://example.com/thumbnail3.jpg', 2103]
    ],
    ...
    'other_creators_in_stream': [
        [2, 'test_streamer_2'],         # creator_id, nick
        [3, 'pro_gamer_test']
    ],
    'chatters_in_stream': [
        [125]                           # count of unique chatters
    ],
    'chatter_messages': [
...
def generate_large_dataset(num_creators: int = 10, num_streams_per_creator: int = 20, 
                          num_chatters: int = 1000, num_messages_per_stream: int = 5000) -> Dict[str, List]:
