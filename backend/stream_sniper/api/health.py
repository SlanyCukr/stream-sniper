...
class HealthChecker:
    ...
    def get_detailed_health(self) -> Tuple[HealthStatus, Dict[str, Any]]:
        ...
        component_statuses = [
            db_health.status,
            cache_health.status,
            rate_limit_health.status,
            twitch_health.status
        ]
        ...
        health_data = {
            ...
            "components": {
                ...
                "rate_limiter": {
                    ...
                    "last_check": rate_limit_health.last_check.isoformat() + "Z" if rate_limit_health.last_check else None
                },
                "external_apis": {
                    "twitch": {
