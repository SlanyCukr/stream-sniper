...
if TYPE_CHECKING:
    from ..api.timeline_models import TimelineMoment
...
def detect_moments(buckets, stream_start: Optional[str]) -> List[TimelineMoment]:
    ...
    """
    # Deferred import: analytics must not import the api package at module load (api/__init__
    # eagerly builds the app, which imports this module — an import cycle).
    from ..api.timeline_models import TimelineMoment
